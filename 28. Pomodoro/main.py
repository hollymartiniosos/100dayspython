...
reset_button = Button(text = "Reset", padx= 5, pady=5, highlightthickness=0, command=reset_timer)
reset_button.grid(column=2, row=2)

check_mark = Label(bg=YELLOW, fg=GREEN, font=(FONT_NAME,30,"bold"), padx= 5, pady=5)
